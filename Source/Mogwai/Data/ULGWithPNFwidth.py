...
def render_graph_PathTracerGraph():
    ...
    PositionNormalFwidth = createPass('PositionNormalFwidth')
    g.addPass(PositionNormalFwidth, 'PositionNormalFwidth')
    ...
    g.addEdge('PositionNormalFwidth.PositionNormalFwidth', 'SVGFPass.PositionNormalFwidth')
    g.addEdge('GBufferRT.posW', 'PositionNormalFwidth.PosW')
    g.addEdge('GBufferRT.normW', 'PositionNormalFwidth.NormW')
