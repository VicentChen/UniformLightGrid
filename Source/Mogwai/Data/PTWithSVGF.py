...
def render_graph_PathTracerGraph():
    ...
    g.addEdge('GBufferRasterWithView.posW', 'MegakernelPathTracer.posW')
    g.addEdge('GBufferRasterWithView.normW', 'MegakernelPathTracer.normalW')
    g.addEdge('GBufferRasterWithView.tangentW', 'MegakernelPathTracer.tangentW')
    g.addEdge('GBufferRasterWithView.diffuseOpacity', 'MegakernelPathTracer.mtlDiffOpacity')
    g.addEdge('GBufferRasterWithView.specRough', 'MegakernelPathTracer.mtlSpecRough')
    g.addEdge('GBufferRasterWithView.emissive', 'MegakernelPathTracer.mtlEmissive')
    g.addEdge('GBufferRasterWithView.matlExtra', 'MegakernelPathTracer.mtlParams')
    g.addEdge('GBufferRasterWithView.vbuffer', 'MegakernelPathTracer.vbuffer')
    g.addEdge('GBufferRasterWithView.faceNormalW', 'MegakernelPathTracer.faceNormalW')
    g.addEdge('GBufferRasterWithView.ViewW', 'MegakernelPathTracer.viewW')
